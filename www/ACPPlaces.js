...
var ACPPlaces = (function () {
  ...
  var PLUGIN_NAME = 'ACPPlaces_Cordova';
  ...
  ACPPlaces.getNearbyPointsOfInterest = function (location, limit, success, error) {
    ...
    return exec(success, error, PLUGIN_NAME, FUNCTION_NAME, [location, limit]);
  };
  ...
  ACPPlaces.processGeofence = function (geofence, transitionType, success, error) {
    ...
    return exec(success, error, PLUGIN_NAME, FUNCTION_NAME, [geofence, transitionType]);
  };
  ...
  ACPPlaces.setAuthorizationStatus = function (status, success, error) {
    ...
    return exec(success, error, PLUGIN_NAME, FUNCTION_NAME, [status]);
  };
